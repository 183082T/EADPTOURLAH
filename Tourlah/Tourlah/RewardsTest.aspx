...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" cssClass="text-center" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" 
            ...
            <ItemTemplate>
                <table style="width: 100%">
                    ...
                    <tr>
                        <td class="w3-center">
                            <asp:Label ID="Label2" runat="server" Text='<%# Eval("reward_desc") %>'></asp:Label>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <button idd='<%# Eval("id") %>' Name='<%# Eval("reward_name") %>' Image='<%# Eval("reward_image") %>' Description='<%# Eval("reward_desc") %>' Quantity='<%# Eval("reward_qty") %>' Amount='<%# Eval("reward_amt") %>' runat="server" type="button" onserverclick="editReward_serverClick"></button> 
                        </td>
                    </tr>
                </table>
            </ItemTemplate>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [id], [reward_name], [reward_desc], [reward_amt], [reward_qty], [reward_image] FROM [reward]"></asp:SqlDataSource>
