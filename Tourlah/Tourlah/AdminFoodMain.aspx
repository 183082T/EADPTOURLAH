<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AdminFoodMain.aspx.cs" Inherits="WebApplication2.AdminFoodMain" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="text-align: center;">
        <asp:Button ID="ButtonAdd" runat="server" Text="Add Food Item" OnClick="ButtonAdd_Click" BackColor="#99FF33" Height="70px" Width="170px" Font-Size="Large" />
    </div>
