        ...
        <div style="width: 85%; margin: 0 auto; text-align: center;">
            <table style="width: 100%; border: solid 2px black; margin-left: auto; margin-right: auto; background-color: darksalmon;">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TBFoodName" runat="server" Height="30px" Width="200px" Font-Size="Medium"></asp:TextBox>
                    </td>
                    <td class="w3-center">
                        <asp:Label ID="LabelNameError" runat="server" Font-Size="X-Large"></asp:Label>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="width: 217px; height: 50px;">
                        <asp:Button ID="ButtonAdd" runat="server" BackColor="Lime" Height="70px" OnClick="ButtonAdd_Click" Text="Add" Width="120px" Font-Size="Large" />
                    </td>
